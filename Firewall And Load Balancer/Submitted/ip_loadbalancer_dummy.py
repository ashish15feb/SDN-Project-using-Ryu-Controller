...
class iplb (object):
  ...
  def __init__ (self, connection, service_ip, servers = []):
    ...
    self.numOfSessions = {"10.10.1.100": 0, "10.10.1.200": 0, "10.10.1.150": 0}  # IP -> number of sessions
  ...
  def _handle_PacketIn (self, event):
    ...
    if ipp.srcip in self.servers:
      ...
      if entry is None or entry.server not in self.live_servers:
        ...
        totalSessions = self.numOfSessions["10.10.1.100"] + self.numOfSessions["10.10.1.200"] + self.numOfSessions[
          "10.10.1.150"]
        if (totalSessions == 0 or totalSessions % 6 == 1):
          server = "10.10.1.100"
          self.numOfSessions["10.10.1.100"] = self.numOfSessions["10.10.1.100"] + 1
        elif (totalSessions % 6 == 2 or totalSessions % 6 == 3):
          server = "10.10.1.150"
          self.numOfSessions["10.10.1.150"] = self.numOfSessions["10.10.1.150"] + 1
        else:
          server = "10.10.1.200"
          self.numOfSessions["10.10.1.200"] = self.numOfSessions["10.10.1.200"] + 1
