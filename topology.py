...
class MyTopo( Topo ):
    ...
    def __init__( self ):
        ...
        host21 = self.addHost( 'h21', ip='192.168.2.1/24'  )
        host22 = self.addHost( 'h22', ip='192.168.2.1/24'  )
        host23 = self.addHost( 'h23', ip='192.168.2.1/24'  )
        ...
        self.addLink( switch1, switch2, cls=TCLink, **props1)
